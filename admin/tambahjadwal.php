                    ...
                    <div class="container-isibody-tambajadwal">
                        <div class="cardabsen">
                            <div class="button-tableabsen">
                                <a href="tambahabsen.php">Tambah Absen</a>
                            </div>               
                        <div class="judultableabsen">
                            <table>
                                <tr>
                                    <td class="jam">Jam</td>
                                    ...
                                    <td class="jam_masuk">Hari</td>

                                </tr>
                            </table>
                        </div>
                        <div class="containerbodyjadwal">
                        ...
                        <?php while($row = mysqli_fetch_assoc($querygetmatakuliah)) : ?>
                            <div class="tableabsen">
                                ...
                                <div class="buttonpengaturantable">
                                    <a href="hapus.php?kodematkul=<?= $row['kode_matkul'];?>&kodekelas=<?= $row['kode_kelas'];?>" onclick="return confirm('Yakin Ingin Menghapus Absen ?');">x</a>
                                </div>
