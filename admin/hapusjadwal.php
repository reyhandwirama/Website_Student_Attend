                    ...
                    <div class="container-isibody-tambajadwal">
                        <div class="cardtambahabsen">
                            ...
                            <div class="bodytambahabsen">
                                <form action="hapusj.php" method="post">
                                    <select name="namamatkul">
                                        <option value="">Pilih Kode Kelas</option>
                                        <?php while($daftarmatakuliah = mysqli_fetch_assoc($get_matakuliah)): ?>
                                            
                                        <option value="<?= $daftarmatakuliah['kode_kelas']; ?>"><?php echo "{$daftarmatakuliah['kode_kelas']} ({$daftarmatakuliah['kode_matkul']},{$daftarmatakuliah['nama_matkul']},{$daftarmatakuliah['hari']})"; ?></option>
                                        <?php endwhile ?>
                                    </select>
                                    <button type="submit" name="hapus" class="tambah" onclick="window.location.href='hapusj.php'"> Hapus </button>
                                    <button type="button" name="cancel" onclick="window.location.href='tambahjadwal.php'">Batal</button>
                                </form>
                            </div>
                        </div>
                    </div>
