...
$query1 = "SELECT * FROM matakuliah WHERE kode_kelas='$kode_kelas'";
        ...
        <div class="body-member">
            <div class="body-container">
                    <div class="container-isibody-tambajadwal">
                        ...
                        <div class="judultableabsen judultablejadwalmember">
                            <table>
                                <tr>
                        ...
                        <div class="containertableabsen containertablejadwalmahasiswa">
